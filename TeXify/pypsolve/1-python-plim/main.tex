...
\subsection{程序设计的语法(grammar)与语义(schematics)}
...
\subsection{Python代码执行可视化(visualization): 一个网站}
...
请认真阅读并实践(无论是在脑子还是在交互器(interactive shell)里面)文档https://docs.python.org/zh-cn/3/tutorial/introduction.html的内容.
